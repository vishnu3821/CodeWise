    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:5001/api/placement-prep/public/companies', {
                        ...
                        <div className="cp-card-header">
                            {company.logo_path ? (
                                <div className="company-logo-wrapper">
                                    <img src={`http://localhost:5001/uploads/companies/${company.logo_path}`} alt={`${company.name} logo`} />
                                </div>
                            ) : (
                                <div className="company-logo-wrapper">
