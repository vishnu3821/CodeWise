...
const AdminDashboard = () => {
    ...
    const fetchStats = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/content/admin/stats', getAuthHeader());
            setStats(res.data);
    ...
    const fetchContentManagers = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/content/admin/users', getAuthHeader());
    ...
    const fetchQueue = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/content/admin/review-queue', getAuthHeader());
    ...
    const fetchUsers = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/users', getAuthHeader());
    ...
    const fetchLogs = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/content/admin/audit-logs', getAuthHeader());
    ...
    const fetchAdminExams = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/training-exams/admin/list', getAuthHeader());
    ...
    const handleDeleteExam = async (id) => {
        ...
        try {
            startLoading();
            await axios.delete(`http://localhost:5001/api/training-exams/admin/${id}`, getAuthHeader());
    ...
    const fetchLanguages = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/content/languages', getAuthHeader());
    ...
    const fetchDisabledContent = async () => {
        try {
            ...
            const resQ = await axios.get('http://localhost:5001/api/content/questions?status=disabled', getAuthHeader());
            ...
            const resN = await axios.get('http://localhost:5001/api/content/notes', getAuthHeader());
            const disabledNotes = resN.data.filter(n => n.status === 'disabled' || n.is_active === 0 || n.is_active === false);

            // Fetch All Languages and filter
            const resL = await axios.get('http://localhost:5001/api/content/languages', getAuthHeader());
            const disabledLangs = resL.data.filter(l => l.is_active === 0 || l.is_active === false);

            // Fetch All Exams and filter
            const resE = await axios.get('http://localhost:5001/api/content/exams?status=disabled', getAuthHeader());
    ...
    const handleRestoreContent = async (type, id) => {
        ...
        try {
            ...
            if (type === 'languages') {
                url = `http://localhost:5001/api/content/admin/languages/${id}/status`;
            } else {
                url = `http://localhost:5001/api/content/admin/content/${type}/${id}/status`;
            }
    ...
    const handleOpenReview = async (type, id) => {
        try {
            startLoading();
            const res = await axios.get(`http://localhost:5001/api/content/admin/item/${type}/${id}`, getAuthHeader());
    ...
    const handleSetPassword = async () => {
        ...
        try {
            await axios.post(`http://localhost:5001/api/training-exams/${selectedItem.id}/set-password`,
    ...
    const handleSetPreExamMessage = async () => {
        ...
        try {
            await axios.post(`http://localhost:5001/api/training-exams/${selectedItem.id}/pre-exam-message`, preExamMessage, getAuthHeader());
    ...
    const handleReviewAction = async (action) => {
        ...
        if (action === 'approve' && selectedItem.type === 'exams') {
            ...
            try {
                await axios.post(`http://localhost:5001/api/training-exams/${selectedItem.id}/publish`, {}, getAuthHeader());
        ...
        try {
            await axios.post(`http://localhost:5001/api/content/admin/review/${selectedItem.type}/${selectedItem.id}`,
    ...
    const handleToggleUser = async (id, currentStatus) => {
        ...
        try {
            await axios.patch(`http://localhost:5001/api/content/admin/users/${id}/status`,
    ...
    const handleToggleLanguage = async (id, currentStatus) => {
        ...
        try {
            ...
            await axios.patch(`http://localhost:5001/api/content/admin/languages/${id}/status`,
                { is_active: !currentStatus }, getAuthHeader()
            );
            fetchLanguages();
        } catch (err) {
    ...
    const handleDeleteUser = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:5001/api/content/admin/users/${id}`, getAuthHeader());
    ...
    const fetchIssues = async () => {
        try {
            startLoading();
            const res = await axios.get('http://localhost:5001/api/issues', getAuthHeader());
    ...
    const handleUpdateIssueStatus = async (id, status) => {
        ...
        try {
            await axios.patch(`http://localhost:5001/api/issues/${id}/status`, { status }, getAuthHeader());
            // Update local state
    ...
    const handleAddUser = async () => {
        try {
            await axios.post('http://localhost:5001/api/content/admin/users', newUser, getAuthHeader());
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
                                <div style={{
                                    ...
                                    {selectedItem.profile_picture ? (
                                        <img
                                            src={selectedItem.profile_picture.startsWith('http') ? selectedItem.profile_picture : `http://localhost:5001${selectedItem.profile_picture}`}
                    ...
                    <div className="modal-content" style={{ width: '800px', maxWidth: '90vw' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr)', gap: '2rem' }}>
                            ...
                            <div>
                                ...
                                <div style={{ marginBottom: '1.5rem', borderRadius: '8px', overflow: 'hidden', border: '1px solid #E2E8F0', cursor: 'zoom-in' }} onClick={() => window.open(`http://localhost:5001${selectedIssue.screenshot_url}`, '_blank')}>
                                    <img
                                        src={`http://localhost:5001${selectedIssue.screenshot_url}`}
                    ...
                    <div className="modal-content">
                        ...
                        {selectedItem.type === 'notes' && (
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <a href={`http://localhost:5001${selectedItem.file_url}`} target="_blank" rel="noopener noreferrer" style={{ color: '#3B82F6', textDecoration: 'underline' }}>
                                    Open PDF in new tab
                                </a>
                                <iframe
                                    src={`http://localhost:5001${selectedItem.file_url}`}
                                    width="100%"
                                    height="400px"
